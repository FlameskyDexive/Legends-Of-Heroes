...
namespace LitJson
{
    ...
    public static class UnityTypeBindings
    {
        ...
        public static void Register()
        {
            ...
            Action<UnityEngine.Vector2Int, JsonWriter> writeVector2Int = (v, w) =>
            {
                w.WriteObjectStart();
                w.WriteProperty("x", v.x);
                w.WriteProperty("y", v.y);
            ...
            JsonMapper.RegisterExporter<UnityEngine.Vector2Int>((v, w) =>
            {
                writeVector2Int(v, w);
            });
            ...
            Action<UnityEngine.Vector3Int, JsonWriter> writeVector3Int = (v, w) =>
            {
                w.WriteObjectStart();
                w.WriteProperty("x", v.x);
                w.WriteProperty("y", v.y);
            ...
            JsonMapper.RegisterExporter<UnityEngine.Vector3Int>((v, w) =>
            {
                writeVector3Int(v, w);
            });
