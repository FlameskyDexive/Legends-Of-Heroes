...
namespace ET
{
    public static class BTEditorUtility
    {
        ...
        private static bool TryGetRuntimeNodeScript(BTEditorNodeData node, out UnityEngine.Object scriptAsset)
        {
            ...
            {
                BTNodeKind.Root => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTRootNodeSystem.cs",
                BTNodeKind.Sequence => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTSequenceNodeSystem.cs",
                BTNodeKind.Selector => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTSelectorNodeSystem.cs",
                BTNodeKind.Parallel => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTParallelNodeSystem.cs",
                BTNodeKind.Inverter => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTInverterNodeSystem.cs",
                BTNodeKind.Succeeder => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTSucceederNodeSystem.cs",
                BTNodeKind.Failer => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTFailerNodeSystem.cs",
                BTNodeKind.Repeater => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTRepeaterNodeSystem.cs",
                BTNodeKind.BlackboardCondition => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTBlackboardConditionNodeSystem.cs",
                BTNodeKind.Wait => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTWaitNodeSystem.cs",
                BTNodeKind.SubTree => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTSubTreeNodeSystem.cs",
                BTNodeKind.Service => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTServiceNodeSystem.cs",
                BTNodeKind.Action => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTActionNodeSystem.cs",
                BTNodeKind.Condition => "Assets/Scripts/Hotfix/Share/Module/BehaviorTree/BTConditionNodeSystem.cs",
                _ => string.Empty,
            };
