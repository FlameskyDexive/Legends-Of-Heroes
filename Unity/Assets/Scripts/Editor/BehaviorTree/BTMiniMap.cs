...
namespace ET
{
    public sealed class BTMiniMap : VisualElement
    {
        ...
        public BTMiniMap(BTGraphView graphView)
        {
        ...
        private void OnGenerateVisualContent(MeshGenerationContext context)
        {
            ...
            foreach (BTNodeView nodeView in this.graphView.GetNodeViews())
            {
                ...
                Color fillColor = BTEditorUtility.GetNodeHeaderColor(nodeView.Data.NodeKind, BTNodeState.Inactive);
                fillColor.a = 0.85f;
        ...
        private void DrawConnections(Painter2D painter, Rect worldBounds, Rect innerRect)
        {
            ...
            foreach (var edge in this.graphView.edges.ToList())
            {
                ...
                {
                    case BTConnectionStyle.Straight:
                        DrawLine(painter, from, to);
                        break;
                    case BTConnectionStyle.Curve:
