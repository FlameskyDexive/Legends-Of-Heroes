...
namespace ET.Client
{
    ...
    public static class UIComponentSystem
    {
        public static void Awake(this UIComponent self)
        {
            ...
            self.StackWindowsShowDataQueue?.Clear();
        ...
        /// <param name="self"></param>
        /// <typeparam name="T"></typeparam>
        public static void ShowStackWindow<T>(this UIComponent self, ShowWindowDataBase showData = null) where T : Entity, IUILogic
        {
            WindowID id = self.GetWindowIdByGeneric<T>();
            self.ShowStackWindow(id, showData);
        }
        ...
        /// <param name="self"></param>
        /// <param name="id"></param>
        public static void ShowStackWindow(this UIComponent self,WindowID id, ShowWindowDataBase showData = null) 
        {
           self.StackWindowsQueue.Enqueue(id);
           self.StackWindowsShowDataQueue.Enqueue(showData);
        ...
        private static void PopStackUIBaseWindow(this UIComponent self)
        {
            if (self.StackWindowsQueue.Count > 0)
            {
                ...
                ShowWindowDataBase showData = self.StackWindowsShowDataQueue.Dequeue();
                self.ShowWindow(windowID, showData);
        ...
        private static void PopNextStackUIBaseWindow(this UIComponent self,WindowID id)
        {
            ...
            if (self.IsCheckStackWindow(uiBaseWindow))
            {
        ...
        private static bool IsNeedCheckStackWindow(this UIComponent self, WindowID id)
        {
            UIBaseWindow uiBaseWindow = self.GetUIBaseWindow(id);
            return self.IsCheckStackWindow(uiBaseWindow);
        }

        private static bool IsCheckStackWindow(this UIComponent self, UIBaseWindow uiBaseWindow)
        {
        ...
        public static void ShowWindow(this UIComponent self,WindowID id, ShowWindowDataBase showData = null)
        {
        ...
        /// <typeparam name="T"></typeparam>
        public static void ShowWindow<T>(this UIComponent self, ShowWindowDataBase showData = null) where T : Entity,IUILogic
        {
            WindowID windowsId = self.GetWindowIdByGeneric<T>();
        ...
        /// <param name="id"></param>
        /// <param name="showData"></param>
        public static async ETTask ShowWindowAsync(this UIComponent self,WindowID id, ShowWindowDataBase showData = null)
        {
        ...
        /// <param name="showData"></param>
        /// <typeparam name="T"></typeparam>
        public static async ETTask ShowWindowAsync<T>(this UIComponent self, ShowWindowDataBase showData = null) where T : Entity,IUILogic
        {
            WindowID windowsId = self.GetWindowIdByGeneric<T>();
        ...
        public static void HideWindow(this UIComponent self,WindowID id, bool checkPopNext = true)
        {
        ...
        private static UIBaseWindow ReadyToShowBaseWindow(this UIComponent self, WindowID id, ShowWindowDataBase showData = null)
        {
            UIBaseWindow baseWindow = self.GetUIBaseWindow(id);
            // 如果UI不存在开始实例化新的窗口
            if (null == baseWindow)
        ...
        private static async ETTask<UIBaseWindow> ShowBaseWindowAsync(this UIComponent self,WindowID id, ShowWindowDataBase showData = null)
        {
        ...
        private static void RealShowWindow(this UIComponent self,UIBaseWindow baseWindow, WindowID id, ShowWindowDataBase showData = null)
        {
        ...
        public static void CloseWindow(this UIComponent self,WindowID windowId)
        {
            ...
            var isNeedCheckStackWindow = self.IsNeedCheckStackWindow(windowId);

            self.HideWindow(windowId, false);
            self.UnLoadWindow(windowId);
            Debug.Log("<color=magenta>## close window without PopNavigationWindow() ##</color>");

            if (isNeedCheckStackWindow)
                self.PopStackUIBaseWindow();
        }
