...
namespace ET
{
    public sealed class BTreeMiniMap : VisualElement
    {
        ...
        public BTreeMiniMap(BTreeGraphView graphView)
        {
        ...
        private void OnGenerateVisualContent(MeshGenerationContext context)
        {
            ...
            foreach (BTreeNodeView nodeView in this.graphView.GetNodeViews())
            {
                ...
                Color fillColor = BTreeEditorUtility.GetNodeHeaderColor(nodeView.Data.NodeKind, BTreeNodeState.Inactive);
                fillColor.a = 0.85f;
        ...
        private void DrawConnections(Painter2D painter, Rect worldBounds, Rect innerRect)
        {
            ...
            foreach (var edge in this.graphView.edges.ToList())
            {
                ...
                {
                    case BTreeConnectionStyle.Straight:
                        DrawLine(painter, from, to);
                        break;
                    case BTreeConnectionStyle.Curve:
